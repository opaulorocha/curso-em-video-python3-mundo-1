...
valor_casa = float(input("Qual eh o valor da casa? "))
salario = float(input("Quanto eh o seu salario mensal? "))
anos = int(input("Em quantos anos pretende pagar? "))
prest_mensal = (valor_casa/anos)/12
print("A sua prestacao mensal sera de {:.2f} reais".format(prest_mensal))
